...
(function ($, Drupal, drupalSettings) {
  ...
  $.fn.citiBike = function(options) {
    ...
    var $stationHeader = $('.citi-bike-stations-header', $this);
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.data != null && response.data.content != null) {
            ...
            if ($stationContainer.hasClass('citi-bike-stations-container')) {
    ...
    var initCitiBike = function() {
      ...
      $stationContainer.addClass('citi-bike-stations-container');
      $stationHeader.html('');
  ...
  $(document).ready(function() { console.log($('#citi-bike-stations-container'))
    $('#citi-bike-stations-container').DataTable();
  } );
