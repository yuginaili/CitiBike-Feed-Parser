...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.citi_bike = {
    attach: function (context, settings) {
      ...
      $('.citi-bike-container', context).once('citi-bike-init').each(function(){
        ...
        $(this).facebookAlbum(settings.citi_bike[delta]);
      });
  ...
  $.fn.facebookAlbum = function(options) {
     ...
     * Elements
     */
    var $albumContainer = $('.citi-bike-stations-container', $this);
    var $albumLoader = $('.loading-icon', $this);
    ...
    var loadAlbums = function(after) {
      ...
      $.ajax({
        url: path_prefix + 'citibike/stations',
        dataType: 'json',
  ...
  // Add data Tables Plugin to the results
  $(document).ready(function() { console.log($('#citi-bike-stations-container').DataTable());
