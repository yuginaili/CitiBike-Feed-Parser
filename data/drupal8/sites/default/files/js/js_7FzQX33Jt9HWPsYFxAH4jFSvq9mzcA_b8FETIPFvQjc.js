...
(function ($, Drupal, drupalSettings) {
   ...
   * Unchanging vars
   */
  var path_prefix = drupalSettings.path.baseUrl + drupalSettings.path.pathPrefix + 'citi-bike/';
  var isWebkit = false;
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.data != null && response.data.content != null) {
            ...
            if ($albumContainer.hasClass('stations-covers')) {
