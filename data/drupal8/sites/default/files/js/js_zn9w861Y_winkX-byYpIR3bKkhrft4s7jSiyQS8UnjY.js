 ...
 *
 */
(function ($, Drupal, drupalSettings) { console.log(DataTable());
  ...
  $.fn.citiBike = function(options) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.data != null && response.data.content != null) {
            ...
            if ($stationContainer.hasClass('citi-bike-stations')) {
    ...
    var initCitiBike = function() {
      ...
      $stationContainer.addClass('citi-bike-stations');
      $stationHeader.html('');
